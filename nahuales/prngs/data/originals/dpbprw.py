...
if __name__ == '__main__':
	...
	from testerTools import getSizeOfTheStream4Performance
	...
	keys = getKeys()
	fnPerformance = 'data/performance_{}.csv'.format(iam)
	...
	tests('{}_raw'.format(iam),		 dpbprw, False, False, False)
	tests('{}_XORraw'.format(iam),	 dpbprw, False, False, True)
	tests('{}_crypt'.format(iam),	 dpbprw, True,  False, False)
	tests('{}_XORcrypt'.format(iam), dpbprw, True,  False, True)
	tests('{}_regen'.format(iam),	 dpbprw, False, True,  False)
	tests('{}_XORregen'.format(iam), dpbprw, False, True,  True)
